...
The results are strikingly similar, and a quite unmelodic. Let's look at these two aspects in turn.
...
\begin{itemize}
    \item The lexicographic order was faster to converge than the linear, and the mix between minimisation and lexicographic was even faster.
\end{itemize}